...
public class App {
    public static void main(String[] args) {
        ...
        // anyMatch : No evalua todo el stream, termina cuando encuentra la primera coincidencia
        boolean rpta1 = persons.stream()
                                .anyMatch(startsWithPredicate);   
       // System.out.println(rpta1);     
        // allMatch : Evalua todo el stream bajo la condicion y tienen que cumplirla todas para retornar true
        boolean rpta2 = persons.stream()
                                .allMatch(startsWithPredicate);        
         System.out.println(rpta2);  
        // noneMatch : Evalua todo el stream bajo la condicion que ninguno coincida para ele ejemplo:que inicie con la letra j
